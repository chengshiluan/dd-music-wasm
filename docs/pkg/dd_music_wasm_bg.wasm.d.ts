...
export const parse_bilibili_popular: (a: number, b: number) => [number, number];
export const parse_bilibili_search: (a: number, b: number) => [number, number];
export const parse_kugou_chart: (a: number, b: number) => [number, number];
...
export const parse_netease_chart: (a: number, b: number) => [number, number];
export const parse_netease_search: (a: number, b: number) => [number, number];
export const parse_qq_chart: (a: number, b: number) => [number, number];
...
export const parse_netease_playlist: (a: number, b: number) => [number, number];
